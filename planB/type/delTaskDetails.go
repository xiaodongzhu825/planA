...
type DelTaskDetail struct {
	...
	PddDeleteAt   *time.Time `gorm:"column:pdd_delete_at" json:"pdd_delete_at"`             // 拼多多删除商品时间
	PddDeleteDate *string    `gorm:"column:pdd_delete_date" json:"pdd_delete_date"`         // 拼多多删除商品日期
