...
type CreateTask struct {
	...
	TaskType   string `form:"task_type" validate:"required,oneof=1 2 3 4 5 6 7 10 11"` // 必填，只能是1、2、3、4、5、6、7、10、11
	ImgType    string `form:"img_type" validate:"required,oneof=1 2 3 4"`              // 必填，只能是1、2、3、4
	UpdateType string `form:"update_type" `                                            // 非必填项
	DelNum     string `form:"del_num"`                                                 //非必填项
